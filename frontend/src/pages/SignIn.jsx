    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4 bg-[#fff9f6] dark:bg-[#121212] transition-colors duration-300'>
            <div className='bg-white dark:bg-[#1e1e1e] rounded-2xl shadow-xl w-full max-w-md p-8 border border-gray-100 dark:border-gray-800 transition-colors duration-300'>
                ...
                <p className='text-gray-500 dark:text-gray-400 mb-8 font-medium'>Sign In to your account to get started with delicious food deliveries.</p>
                ...
                <div className='mb-4'>
                    ...
                    <div className='relative'>
                        <input type={`${showPassword ? "text" : "password"}`} className='w-full border border-gray-300 dark:border-gray-700 bg-transparent dark:bg-[#2a2a2a] dark:text-white rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#ff4d2d] transition-colors pr-10' placeholder='Enter your password' onChange={(e) => setPassword(e.target.value)} value={password} required />
                ...
                <div className='text-right mb-6 cursor-pointer text-[#ff4d2d] dark:text-[#f97316] font-semibold hover:underline' onClick={() => navigate("/forgot-password")}>
                    Forgot Password?
                </div>

                <button className='w-full font-bold py-3 rounded-xl transition duration-300 bg-[#ff4d2d] dark:bg-[#ea580c] text-white hover:bg-[#e64323] dark:hover:bg-[#f97316] shadow-lg hover:shadow-xl cursor-pointer flex justify-center items-center' onClick={handleSignIn} disabled={loading}>
                ...
                <p className='text-center mt-8 text-gray-600 dark:text-gray-400 font-medium cursor-pointer'>Don't have an account? <span className='text-[#ff4d2d] dark:text-[#f97316] hover:underline font-bold' onClick={() => navigate("/signup")}>Sign Up</span></p>
            </div>
        </div>
    )
}
